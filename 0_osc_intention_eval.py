...
def main():
    ...
    osc_base_path = "/C20545/jeremyj/pro/volkswagen_intention_eval/data/CQU/generated_scenarios-v3.0.0-step200"
    ...
    print(f"\n处理完成! 成功处理 {success_count} 个OSC文件，共 {len(osc_files)} 个文件")
